    ...
    Private Sub btnSmall_Click(sender As Object, e As EventArgs) Handles btnSmall.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE intItemID = 10"
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 10 '," & "' 2.50 '," & "  GETDATE() )"
    ...
    Private Sub btnMedium_Click(sender As Object, e As EventArgs) Handles btnMedium.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE intItemID = 11 "
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 11 '," & "' 3.00 '," & "  GETDATE() )"
    ...
    Private Sub btnLarge_Click(sender As Object, e As EventArgs) Handles btnLarge.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE intItemID=12"
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 12 '," & "' 4.00 '," & "  GETDATE() )"
