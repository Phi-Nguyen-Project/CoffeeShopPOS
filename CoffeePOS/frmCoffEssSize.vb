Public Class frmCoffEssSize
    ...
    Private Sub btnSmall_Click(sender As Object, e As EventArgs) Handles btnSmall.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE strCategory = 'Coffee'
                            AND strItemName = 'Espresso Coffee Small' AND strSize ='Small' "
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 1 '," & "' 3.50 '," & "  GETDATE() )"
    ...
    Private Sub btnMedium_Click(sender As Object, e As EventArgs) Handles btnMedium.Click
        Try
            ...
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE strCategory = 'Coffee'
                            AND strItemName = 'Espresso Coffee Medium' AND strSize ='Medium' "
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 2 '," & "' 4.00 '," & "  GETDATE() )"
    ...
    Private Sub btnLarge_Click(sender As Object, e As EventArgs) Handles btnLarge.Click
        Try
            ...
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE strCategory = 'Coffee'
                            AND strItemName = 'Espresso Cofee Large' AND strSize ='Large' "
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 3 '," & "' 4.50 '," & "  GETDATE() )"
