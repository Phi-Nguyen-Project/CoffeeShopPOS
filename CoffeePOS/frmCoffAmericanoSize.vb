Public Class frmCoffAmericanoSize
    Private Sub btnSmall_Click(sender As Object, e As EventArgs) Handles btnSmall.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE 
                            intItemID = 7"
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 7 '," & "' 3.00 '," & "  GETDATE() )"
    ...
    Private Sub btnMedium_Click(sender As Object, e As EventArgs) Handles btnMedium.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE intItemID = 8 "
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 8 '," & "' 3.50 '," & "  GETDATE() )"
    ...
    Private Sub btnLarge_Click(sender As Object, e As EventArgs) Handles btnLarge.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE intItemID = 9"
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 9 '," & "' 4.50 '," & "  GETDATE() )"
