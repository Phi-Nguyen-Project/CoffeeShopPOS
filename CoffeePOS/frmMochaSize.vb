    ...
    Private Sub btnSmall_Click(sender As Object, e As EventArgs) Handles btnSmall.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE intItemID = 16"
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 16 '," & "' 3.75 '," & "  GETDATE() )"
    ...
    Private Sub btnMedium_Click(sender As Object, e As EventArgs) Handles btnMedium.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE intItemID = 17 "
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 17 '," & "' 4.25 '," & "  GETDATE() )"
    ...
    Private Sub btnLarge_Click(sender As Object, e As EventArgs) Handles btnLarge.Click
        Try
            ...
            If OpenDatabaseConnectionSQLServer() = False Then
                ...
                Me.Close()
            End If
            strSelect = "SELECT intItemID, strCategory, strItemName, strSize, monPrice FROM TItems WHERE intItemID=18"
            ...
            strInsert = "Insert into TOrders ( intOrderNum, intItemID, monItemPrice, dtmSaleDate)" &
              " Values ('" & CInt(Int(frmMenu.lblOrderNumber.Text)) & "'," & "' 18 '," & "' 5.00 '," & "  GETDATE() )"
